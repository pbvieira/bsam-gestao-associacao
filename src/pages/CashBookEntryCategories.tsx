  ...
  return (
    <MainLayout>
      <PageLayout
        ...
        subtitle="Gerencie as categorias de entrada do livro caixa dos alunos"
        actionButton={
      ...
      >
        <div className="space-y-4">
          {isLoading ? (
            ...
            <Card><CardContent className="p-6 text-center text-muted-foreground">Nenhuma categoria de entrada cadastrada</CardContent></Card>
          ) : (
        ...
        <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
          <DialogContent>
            <DialogHeader>
              <DialogTitle>{selectedItem ? 'Editar Categoria de Entrada' : 'Nova Categoria de Entrada'}</DialogTitle>
            </DialogHeader>
            <div className="space-y-4">
...
export default CashBookEntryCategories;
