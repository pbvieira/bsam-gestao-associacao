...
import { Loader2, Upload, Download, Trash2, FileText, Image, Video, File, Eye } from 'lucide-react';
import { ImageViewerDialog } from './image-viewer-dialog';
import type { StudentDocument } from '@/hooks/use-student-documents';
...
export function StudentDocumentsTab({ studentId }: StudentDocumentsTabProps) {
  const { documents, loading, uploadDocument, downloadDocument, deleteDocument, getDocumentUrl } = useStudentDocuments(studentId);
