...
import { Users, Package, BarChart3, Home, User, ShoppingCart, Warehouse, LogOut, CheckSquare, Calendar, Shield, Pill, Settings, Stethoscope, CalendarCheck, History, ChevronDown, LayoutDashboard, GraduationCap, BarChart2, ShieldCheck, Syringe, Kanban } from "lucide-react";
...
const navGroups: NavGroup[] = [
  ...
  },
  {
    ...
    icon: Kanban,
    items: [
      { name: "Pendências", href: "/pendencias", icon: Kanban, module: "pendencies" },
    ],
  },
  {
    id: "alunos",
